...
function Footer() {
  return (
    <div
      id="contact"
      className="w-full bg-black lg:px-22 px-5 py-10 flex flex-col
    justify-center items-center gap-12"
    >
      <div
        id="top"
        className="bg-[#046e8f] w-full lg:px-10 p-6 rounded-md flex
      lg:flex-row flex-col justify-between items-start -mt-30 gap-6"
      >
        <div
          className="lg-w-[70%] w-full flex flex-col justify-between items-start
        gap-5"
        >
          <h1
            className="text-3x1 font-fakhwang font-semibold text-white text-left
          lg:w-[60%] w-full"
          >
        ...
        <div
          className="lg:w-[30%] w-full flex flex-col justify-between items-start
        gap-5"
        >
...
rounded-md text-black"
      ...
      <div
        id="mid"
        className="text-white w-full flex lg:flex-row flex-col justify-between
      items-start gap-10"
      >
        {/* 1st box */}
        <div className="lg:w-[40%] w-full">
          <h1 className="text-3xl font-fakhwang font-semibold">
    ...
    gap-2"
        ...
        <div className="lg:w-[20%] w-full">
          ...
          <ul className="flex flex-col justify-between items-start gap-3 mt-5">
            ...
            <li
              className="text-gray-300 hover:text-orange-600 cursor-pointer"
            >
              Services
            </li>
            <li
 ...
 cursor-pointer"
        ...
        <div className="lg:w-[20%] w-full">
          ...
          <ul className="flex flex-col justify-between items-start gap-3 mt-5">
            <li
              className="text-gray-300 hover:text-orange-600 cursor-pointer flex justify-between items-center gap-2"
            >
            ...
            <li
              className="text-gray-300 hover:text-orange-600 cursor-pointer flex justify-between items-center gap-2"
            >
              <AiFillInstagram className="text-orange-600 text-xl" />
              Instagram
            </li>
            <li
              className="text-gray-300 hover:text-orange-600 cursor-pointer flex justify-between items-center gap-2"
      ...
      <hr className="w-full- border border-gray-800"></hr>
      <div id="last" className="flex justify-between items-center gap-2">
        <p className="text-gray-300 text-center">
          Copyright 2026, Felipe Carrillo Puerto, All Rights Reserved
        </p>
      </div>
    </div>
  );
